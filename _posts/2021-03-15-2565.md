...
public class Main{
    ...
    public static void main(String[] args) throws IOException {
        ...
        //같은 등호는 뺴고
        //n번째 -1 보다 크고 n번째 -2 보다 작은 범위 내애서
        //line[][0], line[][1]에 선그어진게 있는지 확인

        //이 함수가 돌면서 걸리는게 있다면 false, 걸리는게 없으면 true
        //메인에서 이 함수를 돌려보고 걸리는게 있다면 삭제하고 count++
        //메인에서 무한루프로 이 함수를 돌리고, 만약 이 함수가 true를 리턴하면 count를 출력
